'''
Install these Libraries in cmd : streamlit,openai,langchain,langchain_community,
google-search-results,wikipedia,lxml,bs4
'''
...
def main():
    ...
    st.markdown(
        "This is a Company Info Extracter . Enter Company name below:"
    )

    user_input = st.text_input("Comapany Name:")
    if user_input:
        st.write("Company: ", user_input)
